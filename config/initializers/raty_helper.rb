module RatyHelper
  ...
  def rating_for(rateable_obj, dimension=nil, options={})
    ...
    star_on      = options[:star_on]      || url('/images/ratyrate/star-on.png')
    star_off     = options[:star_off]     || url('/images/ratyrate/star-off.png')
    star_half    = options[:star_half]    || url('/images/ratyrate/star-half.png')
    cancel       = options[:cancel]       || false
    cancel_place = options[:cancel_place] || 'left'
    cancel_hint  = options[:cancel_hint]  || 'Cancel current rating!'
    cancel_on    = options[:cancel_on]    || url('/images/ratyrate/cancel-on.png')
    cancel_off   = options[:cancel_off]   || url('/images/ratyrate/cancel-off.png')
    ...
    if options[:imdb_avg] && readOnly
      content_tag :div, '', :style => "background-image:url('#{url('/images/ratyrate/mid-star.png')}');width:61px;height:57px;margin-top:10px;" do
  ...
  def imdb_style_rating_for(rateable_obj, user, options = {})
    ...
    content_tag :div, '', :style => "background-image:url('#{url('/images/ratyrate/big-star.png')}');width:81px;height:81px;margin-top:10px;" do
